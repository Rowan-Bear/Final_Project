...
public class PlaylistService {
	...
	public Playlist submitNewPlaylist(Set<Long> songIds, Long websitedId) throws Exception {
		try {
			Optional<Website> foundWebsite = websiteRepo.findById(websitedId);
			Website website = foundWebsite.get();
			Playlist playlist = initializeNewPlaylist(songIds, website);
	...
	public Playlist initializeNewPlaylist(Set<Long> songIds, Website website) {
